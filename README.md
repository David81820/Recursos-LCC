...
<br> Como tal, irei sinalizar material que eu saiba ter origem de alunos, com a etiqueta - **_A_** - no início do nome desses ficheiros. Material criado por mim terá a etiqueta - **_I_** - não só para meu benefício quanto a organização, mas também para quem consultar esse material, para além da minha pessoa, saiba que o material em questão mesmo se útil não é ainda menos digno de confiança que material _A_.
